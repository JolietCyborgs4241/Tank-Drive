...
#include "Commands/FeederWheelIn.h"
#include "Commands/PushBallOut.h"
#include "Commands/FeederStop.h"
#include "Commands/RetrieveBall.h"
#include "Commands/PositionBoxDown.h"
#include "Commands/PositionBoxUp.h"
#include "Commands/FireServo.h"
#include "Commands/ShootBall.h"
#include "Commands/HoldBall.h"
#include "Commands/ShooterStop.h"
#include "Commands/ExtendArm.h"
#include "Commands/PositionArm.h"
#include "Commands/HoldShoot.h"
...
OI::OI() {
	...
	driverJoystickRight = new Joystick (1); //Ps4
	...
	y->WhileHeld(new PositionBoxUp);
	a->WhileHeld(new PositionBoxDown);
	lb->WhileHeld(new FireServo);
	rb->WhileHeld(new ShootBall);
	b->WhileHeld(new RetrieveBall);
	xb->WhileHeld(new PushBallOut);
	back->ToggleWhenPressed(new FeederWheelIn);
	start->WhileHeld(new AutoTurnRight);
//^ps4^
